...
**Progress: 1743 / 2083 exercises solved (84%).** Counts are *live* `sorry`s (proof-term `sorry`, excluding any in comments); “Total” is the number upstream leaves open in that section.
